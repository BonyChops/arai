...
import { Button, Checkbox, Col, Container, Icon, Modal, RadioGroup, Row, Section, TextInput } from "react-materialize"
...
class Play extends React.Component {
    constructor(props) {
        ...
        if (this.props.state !== undefined) {
            if (this.props.state.questions.length <= 0) {
                ...
                setTimeout(() => {
                    ...
                    M.Modal.getInstance(document.querySelector('#noQuestions')).open();
                }, 1)
        ...
        this.state = {
            questions: (props.state.shuffleQuestions ? shuffle(questions) : questions).map(question => ({
                answers: (props.state.shuffleOptions ? shuffle(question.answers) : question.answers).map((option, k) => ((option.selected = false, option.key = k), option)),
                ...
                <Row>
                    <Col offset="m2" m={8} s={12}>
                        ...
                        <Row>
                            ...
                            <Col offset="s8" s={2} className="right-align">
                                <Button onClick={() => this.checkAnswer(currentQuestion)} className={(currentQuestion.answered ? "light-blue" : "orange") +  " right-align"}>
